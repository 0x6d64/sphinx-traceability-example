# -*- coding: utf-8 -*-
#
# exemplum documentation build configuration file, created by
# sphinx-quickstart on Sun Aug  7 20:12:32 2016.
#
...
project = u'exemplum'
copyright = u'2016, Martin Demling'
...
latex_documents = [
  ('index', 'exemplum.tex', u'exemplum Documentation',
...
man_pages = [
    ('index', 'exemplum', u'exemplum Documentation',
     [u'Martin Demling'], 1)
]
...
texinfo_documents = [
  ('index', 'exemplum', u'exemplum Documentation',
   u'Martin Demling', 'exemplum', 'One line description of project.',
   'Miscellaneous'),
]
...
def setup(app):
    from sphinxcontrib.traceability import ItemDirective
