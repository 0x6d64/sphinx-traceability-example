...
project = u'sphinx-traceability-example'
copyright = u'2019, Martin Demling'
author = u'Martin Demling'
...
latex_documents = [
    (master_doc, 'sphinx-traceability-example.tex', u'sphinx-traceability-example Documentation',
